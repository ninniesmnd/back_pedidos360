...
(1, 'cocina.local1@tudominio.com', 1),
...
VALUES (1, 1, 'cliente1@tudominio.com', 'RECIBIDO', 'DELIVERY', '2026-09-07 10:00:00', '2026-09-07 10:00:00');

-- ID 2: Para /api/pedidos/cocina (Local 1, EN_PREPARACION)
INSERT INTO pedidos (id, local_id, cliente_email, estado, tipo_despacho, fecha_creacion, fecha_actualizacion) 
VALUES (2, 1, 'cliente2@tudominio.com', 'EN_PREPARACION', 'RETIRO_EN_TIENDA', '2026-09-07 10:05:00', '2026-09-07 10:15:00');

-- ID 3: Para /api/pedidos/despacho (LISTO_PARA_DESPACHO + DELIVERY)
INSERT INTO pedidos (id, local_id, cliente_email, estado, tipo_despacho, fecha_creacion, fecha_actualizacion) 
VALUES (3, 1, 'cliente1@tudominio.com', 'LISTO_PARA_DESPACHO', 'DELIVERY', '2026-09-07 09:30:00', '2026-09-07 09:50:00');

-- ID 4: En reparto (DELIVERY)
INSERT INTO pedidos (id, local_id, cliente_email, estado, tipo_despacho, fecha_creacion, fecha_actualizacion) 
VALUES (4, 1, 'cliente2@tudominio.com', 'EN_REPARTO', 'DELIVERY', '2026-09-07 09:00:00', '2026-09-07 09:40:00');

-- ID 5: Entregado (Historial para /mis-pedidos y /admin)
INSERT INTO pedidos (id, local_id, cliente_email, estado, tipo_despacho, fecha_creacion, fecha_actualizacion) 
VALUES (5, 1, 'cliente1@tudominio.com', 'ENTREGADO', 'RETIRO_EN_TIENDA', '2026-09-06 18:00:00', '2026-09-06 18:45:00');

-- ID 6: Para probar aislamiento de Local 2 en cocina y admin
INSERT INTO pedidos (id, local_id, cliente_email, estado, tipo_despacho, fecha_creacion, fecha_actualizacion) 
VALUES (6, 2, 'cliente3@tudominio.com', 'RECIBIDO', 'DELIVERY', '2026-09-07 10:10:00', '2026-09-07 10:10:00');
